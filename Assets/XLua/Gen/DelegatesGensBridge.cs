...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp13(HotfixCalc p0, int p1, out double p2, ref string p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp15(double p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp16(UnityEngine.Vector2 p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp17(int p0, string p1, out CSCallLua.DClass p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp30(object p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp31(object p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp32(object p0, object p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(HiXlua.LuaManager.LuaFunction_NoParam))
			{
			    return new HiXlua.LuaManager.LuaFunction_NoParam(__Gen_Delegate_Imp0);
			}
		    ...
		    if (type == typeof(HiXlua.LuaManager.LuaFunction_int))
			{
			    return new HiXlua.LuaManager.LuaFunction_int(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(HiXlua.LuaManager.LuaFunction_int2))
			{
			    return new HiXlua.LuaManager.LuaFunction_int2(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(HiXlua.LuaManager.LuaFunction_float))
			{
			    return new HiXlua.LuaManager.LuaFunction_float(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(HiXlua.LuaManager.LuaFunction_string))
			{
			    return new HiXlua.LuaManager.LuaFunction_string(__Gen_Delegate_Imp4);
			}
			...
			{
			    return new TestOutDelegate(__Gen_Delegate_Imp13);
			}
			...
			{
			    return new System.Action<double>(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Vector2>))
			{
			    return new System.Action<UnityEngine.Vector2>(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(CSCallLua.FDelegate))
			{
			    return new CSCallLua.FDelegate(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(CSCallLua.GetE))
			{
			    return new CSCallLua.GetE(__Gen_Delegate_Imp18);
			}
